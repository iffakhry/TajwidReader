...
//    }
    ...
    private Button imageButton, realtimeButton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        imageButton = (Button)findViewById(R.id.imagebutton);
        realtimeButton = (Button)findViewById(R.id.realtimebutton);

        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageIntent = new Intent(MainActivity.this, ImageDetection.class);
        ...
        realtimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent realtimeIntent = new Intent(MainActivity.this, RealtimeDetection.class);
